...
#define TV_BTN_PIN 8    //для нажатия кнопки телевизора
/******************************************************************************/
 ...
 * 3 - включение ТВ,
 * 4 - время показа ролика,
 * 5 - период звонка телефона,
 * 6 - периодически звоним 
 * {0, 120, 15, 3, 105, 600, 0}  - времена режимов по тех заданию
*/
unsigned long timing[7] = {0, 120, 15, 3, 105, 600, 0};
...
typedef enum {ST_START, ST_LIGHTING, ST_MP_ON, ST_TV_ON, ST_PLAY_VIDEO, ST_PHONE, ST_WAIT} TState; 
TState state;
