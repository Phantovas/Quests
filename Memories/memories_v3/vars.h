 ...
 * @modified Vasiliy A. Ponomarjov September 10, 2015
...
//сигнал успешного прохождения и ожидания         
#define LED_STRIP_PIN            6             //дидная лента подсветки  
#define LOCK_OPEN_PIN            7             //успешное выполнение задания
...
#define TIME_LIGHT_SUCCESS_PROG  2000          //время подсветки при успешном программировании
