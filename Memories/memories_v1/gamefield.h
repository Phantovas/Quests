 ...
 * @modified Vasiliy A. Ponomarjov March 23, 2015
 ...
 * @param AValue byte
 */
void TGameField::fill(byte AValue) {
  for (int i=0;i<TGameField::lengthMatrix();i++) {
    this->Matrix[i] = AValue;
  }
}
